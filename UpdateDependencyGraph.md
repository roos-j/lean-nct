...
- Locate the most recent blueprint file in the blueprint folder (with the highest pass number, if there are files with pass numbers).
- Invoke the python script `dependency_graph/latex_to_graph_json.py` on that blueprint file.
