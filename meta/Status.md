...
\label{thm:ergodicthm}: [Proof completed] (Lean: main_ergodic_theorem) (2026-08-17 05:58:55 EDT)
...
Lean file: Auto/RealToErgodic.lean

#### Theorems

\label{permutation of endpoint estimate}: [Proof completed] (Lean: permutation_of_endpoint_estimate) (2026-08-14 22:42:47 PDT)

\label{multilinear interpolation external}: [Proof completed] (Lean: multilinear_interpolation_external) (2026-08-17 00:53:43 EDT)

\label{exponent polytope}: [Proof completed] (Lean: exponent_polytope, exponent_polytope_of_exponents) (2026-08-14 22:32:24 PDT)

\label{interpolated real variable estimate}: [Proof completed] (Lean: interpolated_real_variable_estimate) (2026-08-17 00:53:43 EDT)

\label{Calderon transference external}: [Proof completed] (Lean: calderon_transference_external) (2026-08-16 16:05:37 PDT)

\label{thm:ergodicthm-interpolation}: [Proof completed] (Lean: ergodic_jump_estimate_interpolation) (2026-08-17 05:58:55 EDT)

\label{thm:ergodicthmJ}: [Proof completed] (Lean: symmetric_ergodic_jump_estimate) (2026-08-17 05:58:55 EDT)
...
Lean file: Auto/Preliminaries

### Notation

Lean file: Auto/Preliminaries/Notation.lean
...
Lean file: Auto/WienerSpace.lean
...
Lean file: Auto/Preliminaries/ConvolutionAlongVector.lean
...
Lean file: Auto/Preliminaries/KKernels.lean
...
Lean file: Auto/Preliminaries/MKernels.lean
...
Lean file: Auto/Preliminaries/MultiplicativelySpacedMonotoneSequences.lean
...
Lean file: Auto/Preliminaries/Gaussians.lean
...
Lean file: Auto/Preliminaries/BumpsAndEstimates.lean
...
Lean file: Auto/MainArgument

### The sandwich kernel

Lean file: Auto/MainArgument/SandwichKernel.lean
...
Lean file: Auto/MainArgument/MultipliersHLN.lean
...
Lean file: Auto/MainArgument/GaussianDomination.lean
...
Lean file: Auto/MainArgument/MainInduction.lean
...
Lean file: Auto/Reduction

### Further preliminaries for the reduction / Average to prism form

Lean file: Auto/Reduction/AToLambda.lean
...
Lean file: Auto/Reduction/VariationSeminorms.lean
...
Lean file: Auto/Reduction/BumpFunctions.lean
...
Lean file: Auto/Reduction/WindowsAndPairs.lean
...
Lean file: Auto/Reduction/SmoothingDecomposition.lean
...
Lean file: Auto/Reduction/Miscellany.lean
...
Lean file: Auto/Reduction/OnDiagonalMainArgument.lean
...
Lean file: Auto/Reduction/OnDiagonalOffDiagonal.lean
...
Lean file: Auto/Reduction/FinalReduction.lean

#### Theorems

\label{lem:main_aux1}: [Proof completed] (Lean: mainAuxOne) (2026-08-14 06:58:39 PDT)
\label{constant main auxiliary one}: [Proof completed] (Lean: constantMainAuxiliaryOne) (2026-08-14 06:58:39 PDT)
\label{lem:shortlongftc_reduction}: [Proof completed] (Lean: shortLongFtcReduction) (2026-08-14 08:10:40 PDT)
\label{lem:mainbump1_long1}: [Proof completed] (Lean: mainBumpOneLongOne) (2026-08-14 08:19:44 PDT)
\label{constant main bump one long one}: [Proof completed] (Lean: constantMainBumpOneLongOne) (2026-08-14 08:19:44 PDT)
\label{lem:mainbump1_long2}: [Proof completed] (Lean: mainBumpOneLongTwo) (2026-08-14 08:32:43 PDT)
\label{constant main bump one long two}: [Proof completed] (Lean: constantMainBumpOneLongTwo) (2026-08-14 08:32:43 PDT)
\label{lem:mainbump1_long}: [Proof completed] (Lean: mainBumpOneLong) (2026-08-14 08:38:57 PDT)
\label{constant main bump one long}: [Proof completed] (Lean: constantMainBumpOneLong) (2026-08-14 08:38:57 PDT)
\label{lem:mainbump1}: [Proof completed] (Lean: mainBumpOne) (2026-08-14 09:06:44 PDT)
\label{constant main bump one}: [Proof completed] (Lean: constantMainBumpOne) (2026-08-14 09:06:44 PDT)
\label{lem:main_aux2}: [Proof completed] (Lean: mainAuxTwo) (2026-08-14 09:14:06 PDT)
\label{constant main auxiliary two}: [Proof completed] (Lean: constantMainAuxiliaryTwo) (2026-08-14 09:14:06 PDT)
\label{lem:mainbump2}: [Proof completed] (Lean: mainBumpTwo) (2026-08-14 09:44:45 PDT)
\label{constant main bump two}: [Proof completed] (Lean: constantMainBumpTwo) (2026-08-14 09:44:45 PDT)
\label{lem:leftbump}: [Proof completed] (Lean: leftBump) (2026-08-14 10:38:03 PDT)
\label{constant left bump}: [Proof completed] (Lean: constantLeftBump) (2026-08-14 10:38:03 PDT)
\label{lem:leftbump1_short1}: [Proof completed] (Lean: leftBumpOneShortOne) (2026-08-14 12:53:07 PDT)
\label{constant left bump one short one}: [Proof completed] (Lean: constantLeftBumpOneShortOne) (2026-08-14 12:53:07 PDT)
\label{lem:leftbump1_short2}: [Proof completed] (Lean: leftBumpOneShortTwo) (2026-08-14 13:16:05 PDT)
\label{constant left bump one short two}: [Proof completed] (Lean: constantLeftBumpOneShortTwo) (2026-08-14 13:16:05 PDT)
\label{lem:leftbump1_long}: [Proof completed] (Lean: leftBumpOneLong) (2026-08-14 13:32:28 PDT)
\label{constant left bump one long}: [Proof completed] (Lean: constantLeftBumpOneLong) (2026-08-14 13:32:28 PDT)
\label{lem:leftbump1}: [Proof completed] (Lean: leftBumpOne) (2026-08-14 13:46:41 PDT)
\label{constant left bump one}: [Proof completed] (Lean: constantLeftBumpOne) (2026-08-14 13:46:41 PDT)
