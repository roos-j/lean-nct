...
Let $n\geq 1$. For an $n$-tuple of real-valued Schwartz functions $\mathbf f =
(f_0,f_1,\dots,f_{n-1})$ on $\R^n$, a bounded measurable function $\chi$ and $x\in\mathbb{R}^n$
denote
...
See also [`Codex.RealToErgodic.twistedAverageAtScale`].
-/
...
See also [`Codex.RealToErgodic.twistedAverage`].
-/
...
For the displayed named constants, see [`Codex.RealToErgodic.mainTwistedTheorem`].
-/
...
Definition [`Codex.RealToErgodic.ergodicAverage`]. -/
...
Let $(X,\Sigma,\mu)$ be a $\sigma$-finite measure space. We say that $T: X \to X$ is a measure
preserving transformation if for every measurable $A\subset X$ the set $T^{-1}(A)$ is measurable
and has the
same measure as $A$.

Let $n\geq 1$ be an integer. Let $\mathbf{f}=(f_l)_{l\in [n)}$ be an $n$-tuple of complex-valued
measurable functions  and let $(T_l)_{l\in [n)}$ be an $n$-tuple of measure preserving
transformations on $X$. For an integer $N\geq 1$ and every $x\in X$, define the multiple ergodic
averages
...
Theorem [`Codex.RealToErgodic.main_ergodic_theorem`]. -/
...
theorem twistedAverageAtScale_permuted {n : ℕ} (π : Equiv.Perm (Fin n))
    ...
    (x : RealVector n) :
    Codex.RealToErgodic.twistedAverageAtScale t χ
        (fun i y ↦ permutedSchwartz π f i y) (coordinatePerm π x) =
      Codex.RealToErgodic.twistedAverageAtScale t χ (fun i y ↦ f i y) x := by
  unfold Codex.RealToErgodic.twistedAverageAtScale
...
theorem twistedAverageAtScale_smul_tuple {n : ℕ} (t : ℝ) (χ : ℝ → ℝ)
    ...
    Codex.RealToErgodic.twistedAverageAtScale t χ (fun i y ↦ a i * f i y) x =
      (∏ i, a i) * Codex.RealToErgodic.twistedAverageAtScale t χ f x := by
  unfold Codex.RealToErgodic.twistedAverageAtScale
    Codex.Reduction.TwistedAverages.twistedAverageAtScale
    Codex.Reduction.TwistedAverages.twistedAverage
...
noncomputable def endpointEnergy {n : ℕ} (J : ℕ) (t : Fin (J + 1) → ℝ)
  ...
  ∑ j : Fin J, eLpNorm
      (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale (t j.succ) χ f x -
        Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) χ f x)
      2 volume ^ 2
...
theorem endpointEnergy_smul_tuple {n : ℕ} (J : ℕ) (t : Fin (J + 1) → ℝ)
  ...
  calc
    ∑ j : Fin J, eLpNorm
        (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale (t j.succ) χ
            (fun i y ↦ a i * f i y) x -
          Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) χ
            (fun i y ↦ a i * f i y) x)
        2 volume ^ 2 =
      ...
      have hfun :
          (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale (t j.succ) χ
            ...
            Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) χ
              (fun i y ↦ a i * f i y) x) =
          (fun x ↦ c *
            (Codex.RealToErgodic.twistedAverageAtScale (t j.succ) χ f x -
              Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) χ f x)) := by
        funext x
...
theorem twistedAverageAtScale_eq_zero_of_component_eq_zero {n : ℕ}
    ...
    (i : Fin n) (hfi : f i = 0) :
    Codex.RealToErgodic.twistedAverageAtScale t χ f = 0 := by
  funext x
  unfold Codex.RealToErgodic.twistedAverageAtScale
    Codex.Reduction.TwistedAverages.twistedAverageAtScale
    Codex.Reduction.TwistedAverages.twistedAverage
...
theorem twistedAverageAtScale_memLp {n : ℕ} (hn : 2 ≤ n)
    ...
    MemLp (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale t unitIntervalKernel
...
theorem twistedAverageAtScale_sub_memLp {n : ℕ} (hn : 2 ≤ n)
    ...
    (hs : 0 < s) (ht : 0 < t) :
    MemLp (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale s unitIntervalKernel
        (fun i y ↦ f i y) x -
      Codex.RealToErgodic.twistedAverageAtScale t unitIntervalKernel
...
theorem endpointEnergy_permuted {n : ℕ} (hn : 2 ≤ n)
  ...
  let dπ : RealVector n → ℝ := fun x ↦
    Codex.RealToErgodic.twistedAverageAtScale (t j.succ) unitIntervalKernel
        (fun i y ↦ permutedSchwartz π f i y) x -
      Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) unitIntervalKernel
        (fun i y ↦ permutedSchwartz π f i y) x
...
theorem endpointEstimate_homogeneous {n : ℕ} (hn : 2 ≤ n)
  ...
  apply endpointEnergy_homogeneous (mainEndpointExponent n) (fun i ↦ by
    ...
    (ENNReal.ofReal ((2 : ℝ) ^ 666) *
      ENNReal.ofReal ((J : ℝ) ^ (1 - (2 : ℝ) ^ (-(n : ℝ) + 2))))
  intro g hg
  exact Codex.RealToErgodic.mainTwistedTheorem hn J hJ t ht htpos g hg
...
private theorem aux_rv_complexTwistedAverage_expand {n : ℕ} (χ : ℝ → ℝ)
    ...
    complexTwistedAverage χ f x =
      ∑ ε : Fin n → Fin 2, aux_rv_complexComponentPhase ε *
        (Codex.RealToErgodic.twistedAverage χ (complexComponent ε f) x : ℂ) := by
  unfold complexTwistedAverage
  ...
  calc
    ...
    _ = (Codex.RealToErgodic.twistedAverage χ (complexComponent ε f) x : ℂ) := by
      rfl
...
private theorem aux_rv_complexTwistedAverageAtScale_sub_expand {n : ℕ}
    ...
    complexTwistedAverageAtScale a χ f x - complexTwistedAverageAtScale b χ f x =
      ∑ ε : Fin n → Fin 2, aux_rv_complexComponentPhase ε *
        ((Codex.RealToErgodic.twistedAverageAtScale a χ (complexComponent ε f) x -
          Codex.RealToErgodic.twistedAverageAtScale b χ (complexComponent ε f) x : ℝ) : ℂ) := by
  unfold complexTwistedAverageAtScale
  ...
  apply Finset.sum_congr rfl
  intro ε _
  simp only [Codex.RealToErgodic.twistedAverage,
    Codex.RealToErgodic.twistedAverageAtScale,
    Codex.Reduction.TwistedAverages.twistedAverageAtScale]
    ...
    (hint : ∀ ε : Fin n → Fin 2, ∀ x : RealVector n, ∀ r : Fin 2,
      Integrable (fun s : ℝ ↦
        (scaleKernel (if r = 0 then a else b) χ s : ℂ) * ∏ i,
          (complexComponent ε f i (x + s • coordinateAxis i) : ℂ)))
    (hmem : ∀ ε : Fin n → Fin 2,
      MemLp (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale a χ
          (complexComponent ε f) x -
        Codex.RealToErgodic.twistedAverageAtScale b χ (complexComponent ε f) x) 2 volume) :
    eLpNorm (fun x ↦ complexTwistedAverageAtScale a χ f x -
      complexTwistedAverageAtScale b χ f x) 2 volume ≤
      ∑ ε : Fin n → Fin 2, eLpNorm
        (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale a χ
            (complexComponent ε f) x -
          Codex.RealToErgodic.twistedAverageAtScale b χ
            (complexComponent ε f) x) 2 volume := by
  let g : (Fin n → Fin 2) → RealVector n → ℂ := fun ε ↦
    aux_rv_complexComponentPhase ε • fun x ↦
      ((Codex.RealToErgodic.twistedAverageAtScale a χ (complexComponent ε f) x -
        Codex.RealToErgodic.twistedAverageAtScale b χ (complexComponent ε f) x : ℝ) : ℂ)
    ...
    (hint : ∀ ε : Fin n → Fin 2, ∀ j : Fin J, ∀ x : RealVector n, ∀ r : Fin 2,
      Integrable (fun s : ℝ ↦
        (scaleKernel (if r = 0 then t j.succ else t j.castSucc) χ s : ℂ) * ∏ i,
          (complexComponent ε f i (x + s • coordinateAxis i) : ℂ)))
    (hmem : ∀ ε : Fin n → Fin 2, ∀ j : Fin J,
      MemLp (fun x ↦ Codex.RealToErgodic.twistedAverageAtScale (t j.succ) χ
          (complexComponent ε f) x -
        Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) χ
...
theorem aux_rv_complexTwistedAverage_ofReal {n : ℕ} (χ : ℝ → ℝ)
    ...
    complexTwistedAverage χ (fun i y ↦ (f i y : ℂ)) x =
      (Codex.RealToErgodic.twistedAverage χ f x : ℂ) := by
  unfold complexTwistedAverage Codex.RealToErgodic.twistedAverage
    Codex.Reduction.TwistedAverages.twistedAverage
  calc
...
theorem aux_rv_complexTwistedAverageAtScale_ofReal {n : ℕ} (t : ℝ) (χ : ℝ → ℝ)
    ...
    complexTwistedAverageAtScale t χ (fun i y ↦ (f i y : ℂ)) x =
      (Codex.RealToErgodic.twistedAverageAtScale t χ f x : ℂ) := by
  unfold complexTwistedAverageAtScale Codex.RealToErgodic.twistedAverageAtScale
    Codex.Reduction.TwistedAverages.twistedAverageAtScale
  ...
  have hsub :
      (fun x ↦ complexTwistedAverageAtScale (t j.succ) χ
        ...
        complexTwistedAverageAtScale (t j.castSucc) χ
          (fun i y ↦ (f i y : ℂ)) x) =
        fun x ↦ ((Codex.RealToErgodic.twistedAverageAtScale (t j.succ) χ f x -
          Codex.RealToErgodic.twistedAverageAtScale (t j.castSucc) χ f x : ℝ) : ℂ) := by
    funext x
...
private theorem ct_twistedAverageAtScale_eq {n : ℕ} (t : ℝ) (ht : 0 < t)
    ...
    Codex.CalderonTransference.twistedAverageAtScale t
      ...
      Codex.RealToErgodic.twistedAverageAtScale t unitIntervalKernel f := by
  funext x
...
\end{equation}
Then there is a finite constant $C_{\text{Calder\'on transference},n,(p_i)_{i\in[n)},C}$ such
that, for every measure space $(X,\Sigma,\mu)$, every family of mutually commuting measure
...
\le C_{\text{Calder\'on transference},n,(p_i)_{i\in[n)},C}g(J)
\prod_{i\in[n)}\|f_i\|_{p_i}^2.
\end{equation}
\end{exttheorem}
...
=2^{2n}C_{\text{Calder\'on transference},n,(p_i)_{i\in[n)},2^{2n}C_{\text{main twisted theorem}}}.
\end{equation}
\end{theorem}

For the displayed named constants, see
[`Codex.RealToErgodic.ergodic_jump_estimate_interpolation`],
[`Codex.RealToErgodic.calderon_transference_external`], [`Codex.RealToErgodic.mainTwistedTheorem`].
-/
...
=2^{2n}C_{\text{Calder\'on transference},n,(2n)_{i\in[n)},2^{2n}C_{\text{main twisted theorem}}}.
\end{equation}
\end{theorem}
...
/-- The constant in Theorem [`Codex.RealToErgodic.main_ergodic_theorem`]; this is the square root of
...
\end{equation}
where for $n=2$,
$C_{\text{main ergodic theorem},2,r}=C_{\text{symmetric ergodic jump
estimate},2}^{1/2}$,\label{main ergodic theorem constant}
and, for $n\ge3$,
$C_{\text{main ergodic
theorem},n,r}=2^{1-2^{1-n}}\left(\tfrac{r}{r-2^{n-1}}\right)^{1/r}C_{\text{symmetric ergodic
jump estimate},n}^{1/2}$.\label{auto:main-ergodic-theorem-constant-higher-rank}
\end{theorem}

For the displayed named constants, see [`Codex.RealToErgodic.main_ergodic_theorem`],
[`Codex.RealToErgodic.symmetric_ergodic_jump_estimate`].
-/
