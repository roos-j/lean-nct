...
See also [`Codex.Preliminaries.Notation.scaledBracketBump`],
[`Codex.Preliminaries.Notation.scaledBracketBumpReal`].
-/
...
See also [`Codex.Preliminaries.Notation.bracketBump`],
[`Codex.Preliminaries.Notation.scaledBracketBumpReal`].
-/
...
See also [`Codex.Preliminaries.Notation.bracketBump`],
[`Codex.Preliminaries.Notation.scaledBracketBump`].
-/
