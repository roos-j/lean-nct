...
Formalization of the manuscript's convolution-along-a-vector construction.
It establishes Wiener-space closure and the Fourier-transform formula for
convolution along an arbitrary Euclidean direction.
-/
