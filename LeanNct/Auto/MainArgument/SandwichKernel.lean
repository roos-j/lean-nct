...
public import LeanNct.Auto.Preliminaries.MultiplicativelySpacedMonotoneSequences
...
theorem aux_integral_gaussianRescale (t : ℝ) (ht : 0 < t) :
  ...
  change (∫ x : ℝ, t⁻¹ * Auto.gaussian (t⁻¹ * x)) = 1
  rw [integral_const_mul,
    Measure.integral_comp_inv_mul_left Auto.gaussian t,
