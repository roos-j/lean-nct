...
\begin{definition}[Ergodic averages]\label{ergodic averages}\lean{ergodicAverage}\uses{}\usesdefs{}
...
\begin{theorem}[Main ergodic theorem]\label{thm:ergodicthm}\lean{main_ergodic_theorem}\leanok\uses{thm:ergodicthmJ,jump estimates imply variation}\usesdefs{ergodic averages}
...
Let $B$ be a seminormed space, $I\subset\mathbb{R}$ a subset and $a:I\to B$ and $J,k\in\mathbb{N}$, $r\ge 1$. The \emph{$r$-variation seminorm} (with at most $J$ jumps) is
