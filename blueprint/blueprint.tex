...
Separate automation passes checked all arguments for local correctness. This of course does not replace mathematical expert review, but has decreased friction during the formalization stage.
Nevertheless, the formalization still surfaced some minor discrepancies in the values of explicit constants in some intermediate propositions, which have then been fixed.
