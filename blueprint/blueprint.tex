...
\begin{theorem}[Main ergodic theorem]\label{thm:ergodicthm}\lean{main_ergodic_theorem}\uses{thm:ergodicthmJ,jump estimates imply variation}\usesdefs{ergodic averages}
...
\begin{exttheorem}[Multilinear interpolation]\label{multilinear interpolation external}\lean{multilinear_interpolation_external}\uses{}\usesdefs{}
...
\begin{proposition}[Interpolated real-variable estimate]\label{interpolated real variable estimate}\lean{interpolated_real_variable_estimate}\uses{permutation of endpoint estimate,exponent polytope,multilinear interpolation external}\usesdefs{A_def}
...
\begin{exttheorem}[Calder\'on transference principle]\label{Calderon transference external}\lean{calderon_transference_external}\uses{}\usesdefs{ergodic averages,A_def}
...
\begin{theorem}[Ergodic jump estimate with general exponents]\label{thm:ergodicthm-interpolation}\lean{ergodic_jump_estimate_interpolation}\uses{interpolated real variable estimate,Calderon transference external}\usesdefs{ergodic averages}
...
\begin{theorem}[Symmetric ergodic jump estimate]\label{thm:ergodicthmJ}\lean{symmetric_ergodic_jump_estimate}\uses{thm:ergodicthm-interpolation}\usesdefs{ergodic averages}
