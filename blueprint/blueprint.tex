...
\begin{definition}[Multiple ergodic average]\label{ergodic averages}\lean{nCT.multipleErgodicAverage}\uses{}\usesdefs{}
...
\begin{theorem}[Main ergodic theorem]\label{thm:ergodicthm}\lean{nCT.main_ergodic_theorem}\leanok\uses{thm:ergodicthmJ,jump estimates imply variation}\usesdefs{ergodic averages}
...
\begin{definition}[Twisted average]\lean{nCT.twistedAverage,nCT.rescaledTwistedAverage}
